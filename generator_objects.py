...
def main():
    ...
    print("The sum of the first 1M squared numbers is: ", sum(x*x for x in range(1,10000)))

    # the sum of the prime numbers between 1 to 10K
    print("The sum of the first 10K squared numbers is: ", sum(x for x in range(1, 10000) if is_prime(x)))
